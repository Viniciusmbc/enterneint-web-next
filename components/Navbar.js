...
export default function Navbar({ activeTab = -1, buttons, setActiveTab }) {
  return (
    <nav className="flex items-center justify-between bg-semiDarkBlue py-5 px-4 md:flex-col md:ml-8 md:my-8 md:rounded-2xl md:justify-start ">
