// Home Icon
export const HomeIcon = ({ pathname }) => (
  <svg
    className={`hover:fill-red ${
      pathname ? `fill-white hover:fill-white` : " fill-greyishBlue"
    } mx-2`}
    width="20"
    height="20"
...
// Movies Icon
export const MoviesIcon = ({ pathname }) => (
  <svg
    className={`hover:fill-red ${
      pathname ? `fill-white hover:fill-white` : " fill-greyishBlue"
    } mx-2`}
...
// Bookmarks Icon
export const BookmarkIcon = ({ pathname }) => (
  <svg
    className={`hover:fill-red ${
      pathname ? `fill-white hover:fill-white` : " fill-greyishBlue"
    } mx-2`}
